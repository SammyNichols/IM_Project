package com.inventoryProject.IMProject.service;
...
import com.inventoryProject.IMProject.repository.CustomerRepository;
import com.inventoryProject.IMProject.repository.OrderRepository;
import com.inventoryProject.IMProject.repository.ProductRepository;
import com.inventoryProject.IMProject.util.MembershipLevel;
import com.inventoryProject.IMProject.util.OrderStatus;
...
public class OrderService {
	...
	public Order submitNewOrder(Set<Long> productIds, Long customerId) throws Exception {
		try {
			...
			logger.error("Exception occurred while trying to create new order for customer: " + customerId);
			throw e;
		}
	}
	...
	public Order cancelOrder(Long orderId) throws Exception {
		try {
			...
			logger.error("Exception occurred while trying to cancel order: " + orderId);
	...
	public Order completeOrder(Long orderId) throws Exception {
		try {
			...
			logger.error("Exception occurred while trying to complete order: " + orderId);
			throw new Exception("Unable to update order");
		}
	}

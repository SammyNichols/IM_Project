package com.inventoryProject.IMProject.controller;
...
import com.inventoryProject.IMProject.service.ProductService;
...
public class ProductController {
	...
	public ResponseEntity<Object> deleteProduct(@PathVariable Long id) {
		try {
			...
			return new ResponseEntity<Object>("Successfully deleted products", HttpStatus.OK);
		} catch (Exception e) {
			return new ResponseEntity<Object>("Unable to delete product: " + id, HttpStatus.BAD_REQUEST);
		}
	}
